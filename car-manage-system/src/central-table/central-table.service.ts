...
import { CreateCTableDTO } from './dto/create-ctable.dto';
import { UpdateCTableDTO } from './dto/update-ctable.dto';
...
export class CentralTableService {
  constructor(
    ...
    //@InjectRepository(CALogin)
    //private readonly loginRepo: Repository<CALogin>,
  ) {}
